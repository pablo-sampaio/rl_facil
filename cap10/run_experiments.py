...
if __name__=='__main__':
    ...
    plot_multiple_results(results, cumulative=False, plot_stddev=False, return_type='steps')
    plot_multiple_results(results, cumulative=True, plot_stddev=False, return_type='steps')
