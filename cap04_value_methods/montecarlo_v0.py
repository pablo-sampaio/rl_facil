...
# da tablea Q, usando uma estratégia epsilon-greedy.
...
# Atenção: o espaços de estados e de ações precisam ser discretos, dados por valores inteiros
def run_montecarlo(env, episodes, gamma=0.95, epsilon=0.01, render=False):
    # assert?
    ...
    for i in range(episodes):
        ...
        # a cada 100 passos, imprime informação sobre o progresso 
        if (i+1) % 100 == 0:
...
if __name__ == "__main__":
    ...
    # Run Monte-Carlo RL control algorithm
